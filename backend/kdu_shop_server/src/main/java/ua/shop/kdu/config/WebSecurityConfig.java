    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                    .csrf().disable()
                    .authorizeRequests()
                        .antMatchers("/api/auth/change-email", "/api/auth/change-password", "/api/user/account-info").authenticated()
                        .antMatchers(HttpMethod.GET, "/img/**", "/api/product/search", "/api/product/popular", "/", "/static/**").permitAll()
                        ...
                        .antMatchers("/api/categories", "/api/categories/**", "/api/product/**", "/api/product**", "/api/orders**", "/api/orders/**", "/api/orders/all**", "/api/user", "/api/user/**").hasAnyAuthority(Role.ADMIN.getAuthority())
